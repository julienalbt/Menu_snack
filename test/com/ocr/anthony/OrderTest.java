...
public class OrderTest {
    ...
    @Test
    public void Given_VegetarianWithNoRiceAndGasWaterInStandardInput_When_MenuIsRun_Then_DisplayCorrectProcess() {
    ...
    @Test
    public void Given_DrinkWater_When_DisplayDrinkSelected_Then_displayWaterSentence() {
        order.displaySelectedDrink(1);
        String output = outContent.toString().replace("\r\n", "\n");
        assertEquals("Vous avez choisi comme boisson : eau plate\n", output);
    }
    @Test
    public void Given_DrinkGasWater_When_DisplayDrinkSelected_Then_displayGasWaterSentence() {
        order.displaySelectedDrink(2);
        String output = outContent.toString().replace("\r\n", "\n");
        assertEquals("Vous avez choisi comme boisson : eau gazeuse\n", output);
    }
    @Test
    public void Given_DrinkSoda_When_DisplayDrinkSelected_Then_displaySodaSentence() {
    ...
    @Test
    public void Given_TwoMenu_BeefWithVegetable_VegetarianWithNoRiceAndGasWaterInStandardInput_When_MenusIsRun_Then_DisplayCorrectProcess() {
        System.setIn(new ByteArrayInputStream("2\n2\n1\n3\n2\n2\n".getBytes()));
        order = new Order();
        order.runMenus();
        String[] output = outContent.toString().replace("\r\n", "\n").split("\n");
